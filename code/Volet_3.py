...
"""
document_path = "C:/Users/robbe/Documents/github/NACA0012/13_04/Volets/"
...
ax.plot(incidence2,cla2,'-r',label = "Sans volet")
...
ax.plot(incidence2,cxa2,'-r',label = "Sans volet")
ax.set_xlabel('$Incidence$')
ax.set_ylabel('$Cxa$')
ax.grid(True)
ax.legend()
...
ax.plot(incidence2,cma2,'-r',label = "Sans volet")
ax.set_xlabel('$Incidence$')
ax.set_ylabel('$Cma$')
ax.grid(True)
ax.legend()
...
ax.plot(cxa2,cla2,'-r',label = "Sans volet")
ax.set_xlabel('$Cma$')
ax.set_ylabel('$Cla$')
ax.grid(True)
ax.legend()
...
ax.plot(incidence2,speed2,'-r',label = "Sans volet")
ax.set_xlabel('$Incidence$')
...
print("finesse max sans volet ", max(cla2/cxa2))
