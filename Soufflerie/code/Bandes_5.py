...
file_name3 = "20ms_2Bandes_corr_new.res"
file_name4 = "20ms_4Bandes_corr.res"
file_name5 = "20ms_2BandesArriere_corr.res"
...
rst5,incidence5,cla5,cxa5,cma5,speed5,za5,xa5,ma5  = file_reading(document_path,file_name5)
...
#ax.plot(incidence3,cla3,'-g',label = "2 Bandes - New")
#ax.plot(incidence4,cla4,'-k',label = "4 Bandes")
ax.plot(incidence5,cla5,label = "2 Bandes- Arrière")
...
ax.plot(incidence3,cxa3,'-g',label = "2 Bandes - New")
...
ax.plot(incidence3,cma3,'-g',label = "2 Bandes - New")
...
fig,ax = plt.subplots()
ax.plot(cxa,cla,'-b',label = "0 Bandes")
ax.plot(cxa2,cla2,'-r',label = "2 Bandes")
#ax.plot(cla3,cxa3,'-g',label = "2 Bandes - New")
#ax.plot(cla4,cxa4,'-k',label = "4 Bandes")
ax.plot(cxa5,cla5,label = "2 Bandes- Arrière")
ax.set_xlabel('$Cxa$')
ax.set_ylabel('$Cla$')
ax.grid(True)
ax.legend()
...
ax.plot(incidence3,speed3,'-g',label = "2 Bandes - New")
...
print("finesse max avec 2 bandes - New: " , max(cla3/cxa3))
